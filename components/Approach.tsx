    ...
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                ...
                <Card title="NMIMS" icon={<AceternityIcon order="Bachelor's" />} description="Bachelor's in Computer Engineering">
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card title="IIT" icon={<AceternityIcon order="Master's"/>} description="Master's in Computer Science">
                    <CanvasRevealEffect
                        animationSpeed={3}
